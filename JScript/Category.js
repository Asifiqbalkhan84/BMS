...
function BindTable() {
    $.ajax({
        ...
        url: 'Category.aspx/GetCategoryList',
                    ...
                    },
                    {
                        ...
                        'render': function (data, type, full, meta) {
                            return '<div class="btn-icon-list">' +
                                '<a type="button"  class="btnEdit btn btn-edit"  href="AddCategory.aspx?ID=' + full.CatID + '">' +
                                '<i class="typcn typcn-edit" title="Edit Record"></i></a>' +
                                '<a type="button" class="btnDelete btn btn-delete" onclick="Delete(this.id)" id="' + full.CatID + '" >' +
